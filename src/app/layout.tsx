...
export const metadata: Metadata = {
  metadataBase: new URL('https://tools-site-khaki-seven.vercel.app'),
...
const websiteSchema = {
  ...
  '@type': 'WebSite',
  name: '实用计算器',
  url: 'https://tools-site-khaki-seven.vercel.app',
  description: '提供折扣计算器、BMI计算器、日期计算器、农历转换、单位换算等实用在线工具',
  potentialAction: {
    '@type': 'SearchAction',
    target: {
      '@type': 'EntryPoint',
      urlTemplate: 'https://tools-site-khaki-seven.vercel.app/?q={search_term_string}',
    },

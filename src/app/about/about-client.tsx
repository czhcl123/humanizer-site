...
const T = {
  zh: {
    ...
    howWorks: '工作原理',
    howWorksBody: '后端调 Anthropic Claude,prompt 工程专门设计打破 AI 检测器识别的统计特征:变化句子长度、加口语化转折、用第一人称和模糊词、减少列表化结构、避免 AI 八股词。输入通过无状态 API 处理,处理完立即丢弃,不存储,不分析,不训练。',
    privacy: '隐私保护',

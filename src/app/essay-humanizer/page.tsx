...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Is AI Essay Humanizer really free?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. AI Essay Humanizer is 100% free with no premium tier, no signup, and no installation. Paste your paper text, click Humanize, and get a natural-sounding rewrite. Up to 3,000 characters per submission.' } },
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ lang?: string }> }) {
  ...
  const titles = {
    ...
    en: 'AI Essay Humanizer - Free paper Rewriter, Bypass Turnitin',
  }
  const descriptions = {
